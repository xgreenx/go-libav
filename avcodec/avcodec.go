...
//}
//
// int GO_AVCODEC_VERSION_MAJOR = 2;
// int GO_AVCODEC_VERSION_MINOR = 2;
// int GO_AVCODEC_VERSION_MICRO = 2;
//
...
func (pkt *Packet) SetData(data []byte) {
	pkt.CAVPacket.data = (*C.uint8_t)(C.CBytes(data))
}
...
func findBestPixelFormatWithLossFlags(list []avutil.PixelFormat, src avutil.PixelFormat, alpha bool, lossFlags *avutil.LossFlags) avutil.PixelFormat {
	...
	value[size] = C.enum_AVPixelFormat(avutil.PIX_FMT_NONE)
